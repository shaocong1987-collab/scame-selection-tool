...
A web-based tool for SCAME industrial plug and socket selection.

## Features

- Forward selection: Find products by model number
- Reverse selection: Find products by technical specifications
- Quick selection: Industry-specific scenarios
